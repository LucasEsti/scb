 ...
 */
get_header(); ?>
    <div class="page-head overlay-wrap" style="background: #000 url(<?php echo get_field('background')['url']; ?>) no-repeat center; background-size: cover; padding: 102px 0px 101px;">
